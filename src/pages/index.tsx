			...
			<div className={indexStyles.index}>
				...
				<div
					...
					<p>
						...
						empowerment. Onze ervaringsdeskundige teamleden delen hun
						levensverhalen en begeleiden workshops, waarbij thema's als
						veiligheid, identiteit, en sociale druk worden behandeld.
					</p>
				</div>
				...
				<div
					...
					<ol>
						<li>
							...
							<p>
								Een dag waarop onze teamleden de reguliere lessen overnemen.
								Door middel van kunst, muziek, sport en persoonlijke verhalen
								inspireren we jongeren om positieve keuzes te maken.
							</p>
						</li>
						<li>
							<h4>KIR Workshops</h4>
						...
						<li>
							...
							<p>
								Specifieke ondersteuning voor leerlingen die dat nodig hebben,
								om hen te helpen bij het nemen van de regie over hun leven.
							</p>
						</li>
					</ol>
				...
				<div
					...
					<p>
						...
						begeleiden van jongeren. Van voormalige straatlegendes tot ervaren
						jongerenwerkers, elk teamlid brengt unieke kennis en expertise.
					</p>
				</div>
				...
				<div
					...
					<p>
						...
						scholen en andere partners om ons programma te integreren in het
						curriculum en de bredere gemeenschap. Onze ambities reiken verder
						dan alleen workshops; we willen een cultuur van empowerment creëren
						die jongeren helpt om hun volledige potentieel te bereiken.
					</p>
				</div>
				...
				<div>
					...
					<p>
						Wil je meer horen over de verhalen achter Keep It Real en de
						inspirerende mensen die deel uitmaken van ons team? Luister dan naar
						onze podcast! Hier delen we persoonlijke ervaringen, succesverhalen
