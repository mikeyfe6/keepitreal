		...
		<Layout>
			<section className={anbiStyles.anbi}>
				<div>
					...
					<p>
						Stichting Keep It Real is een culturele instelling die zich richt op
						het bevorderen van de maatschappelijke en culturele participatie van
						jongeren, evenals hun culturele en artistieke ontwikkeling.
					</p>
					...
					<ul>
						<li>
							Sponsorgelden en giften aanvragen en uitbesteden aan projecten
							onder de naam van de Stichting Keep It Real.
						</li>
						<li>
							Het organiseren van activiteiten die bijdragen aan de
							maatschappelijke en culturele participatie van jongeren.
						</li>
						<li>
							Het initiëren en stimuleren van projecten die jongeren
							ondersteunen in hun ontwikkeling.
						</li>
						<li>
							Samenwerken met organisaties en instellingen met vergelijkbare of
					...
					<ol>
						<li>
							De stichting heeft ten doel het bevorderen van de maatschappelijke
							en culturele participatie van jongeren, evenals hun culturele en
						...
						<li>
							...
							<ul>
								...
								<li>
									Samenwerken met vergelijkbare organisaties en instellingen.
								</li>
							</ul>
						</li>
					</ol>
