...
const Hero: React.FC = () => {
    ...
    return (
        <section className={heroStyles.hero}>
            <Script src="https://elfsightcdn.com/platform.js" strategy="post-hydrate" />
            ...
            {/* <div className={heroStyles.visual} hidden>
                <StaticImage src="../../images/hero.jpeg" alt="Keep It Real Hero Image" objectPosition={"100% 62.5%"} />
